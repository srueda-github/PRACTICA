...
<head>
    ...
    <title> Citas de Laboratorio</title>
    <style>
        body {
...
<body>
    <div id="container">
        ...
        <table>
            ...
            try {
                if (conexion != null) {
                    PreparedStatement statement = conexion.prepareStatement("SELECT * FROM solicitud_lab");
            ...
            <% 
                ...
                e.printStackTrace();
                out.println("<tr><td colspan='5'>Error: No se pudieron obtener los datos de las citas de laboratorio.</td></tr>");
            }
            %>
        </table>
    </div>
