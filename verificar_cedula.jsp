...
if (fecha != null && cedula != null && idMedico != null && hora != null) {
    try {
    ...
    mensaje = "Error: Debes seleccionar una fecha, ingresar una cédula, elegir un médico y seleccionar una hora para solicitar la cita.";
}
%>
